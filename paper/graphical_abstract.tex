...
\node[box,right=of rank] (net) {Enumerative wire\\$C_{\rm net}^{\rm map}=C_{\rm gross}-|A|$};
...
{Document benchmark\\mean net payload: 2245 bits\\BOSSbase matched cohort, $q=512$: 309 net bits};
